/**
 * Microservicio de Evaluación Desempeño - Bolsa de Empleados
...
const SERVICE_NAME = 'evaluacion-desempeno';
const PORT = parseInt(process.env.EVALUACION_DESEMPENO_PORT || process.env.PORT || '3009', 10);
