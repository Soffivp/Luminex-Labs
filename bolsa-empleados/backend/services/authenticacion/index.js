/**
 * Microservicio de Autenticación - Bolsa de Empleados
...
const SERVICE_NAME = 'authenticacion';
const PORT = parseInt(process.env.AUTHENTICACION_PORT || process.env.PORT || '3006', 10);
