/**
 * Microservicio de Colocación Laboral - Bolsa de Empleados
...
const SERVICE_NAME = 'colocacion-laboral';
const PORT = parseInt(process.env.COLOCACION_LABORAL_PORT || process.env.PORT || '3007', 10);
